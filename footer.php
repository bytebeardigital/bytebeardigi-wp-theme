    ...
    <div class="container">
        <div class="row">
            <div class="col-md-1 col-lg-2 col-xs-12 footer__logo">      
                <a class="footer__logo--link" href="<?php echo home_url(); ?>"><img width="75px" src="<?php echo $footer_logo; ?>" /></a>
            </div>
            <div class="col-md-4 col-xs-12 footer__contact">
                <h5 class="footer__title">Contact</h5>
                <?php if(!empty($global_phone)):?> <p class="footer__link">phone: <a href="tel:<?php echo $global_phone; ?>">1234567890</a></p><?php endif;?>
                <?php if(!empty($global_email)):?> <p  class="footer__link">email: <a href="info:<?php echo $global_email; ?>"><?php echo $global_email; ?></a></p>
<?php endif;?>
            </div>
